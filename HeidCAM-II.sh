...
export CASROOT=/opt/openCASCADE/lib64
...
then LD_LIBRARY_PATH=$TCLHOME/lib:$FTGLDIR/lib:$GL2PSDIR/lib:$FREEIMAGEDIR/lib:$TBBBIN:$CASROOT/$OS_NAME/lib64;
else LD_LIBRARY_PATH=$TCLHOME/lib:$FTGLDIR/lib:$GL2PSDIR/lib:$FREEIMAGEDIR/lib:$TBBBIN:$CASROOT/$OS_NAME/lib64:$LD_LIBRARY_PATH;
fi
...
export CSF_GraphicShr=/opt/OpenCASCADE/lib64/libTKOpenGl.so
